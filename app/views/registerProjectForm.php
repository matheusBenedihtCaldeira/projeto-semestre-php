            ...
            <form action="../controllers/project/RegisterProjectController.php" enctype="multipart/form-data" method="post">
              ...
              <div class="row">
                <div class="col-md-5 mb-3">
                  <label for="start_date" class="form-label">Inicio do projeto</label>
                  <input type="date" name="start_date" class="form-control" />
                </div>
                <div class="col-md-5 mb-3">
                  <label for="end_date" class="form-label">Fim do projeto</label>
              ...
              <div class="row">
                <div class="col-md-10 mb-3">
                  <div class="form-floating">
                    ...
                    <label for="description">Detalhe do projeto</label>
                  </div>
                </div>
              </div>
              <div class="row">
